...
void CRTable::open()
{
   ...
   columns.emplace("tx_latency_us",
    ...
    columns.emplace("time_counter_0",
        [&](Column& col) { col << (local_time_counter_0 ? local_time_counter_0 : 0); });
    
    columns.emplace("time_counter_1",
        [&](Column& col) { col << (local_time_counter_1 ?  local_time_counter_1 : 0); });
    
    columns.emplace("time_counter_2",
        [&](Column& col) { col << (local_time_counter_2 ? local_time_counter_2 : 0); });
    
    columns.emplace("time_counter_3",
        [&](Column& col) { col << (local_time_counter_3 ? local_time_counter_3 : 0); });
          

    columns.emplace("time_avg_0",
